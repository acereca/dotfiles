...
case $option in
    ...
    MagicalMusic) 
        mpv "ytdl://$(/home/patrick/github/scripts/getyturl.py user/magicalmusicchannel 'Magical Music Radio')" --ytdl-format=93 --vo=null & ;;
    EpicMusic) 
    ...
    *' - FHR')
        mpv "ytdl://$(/home/patrick/github/scripts/getyturl.py channel/UCE7gceSq79z8uW7cTe86UaA ${option% - FHR})" --ytdl-format=93 --vo=null & ;;
    '-> kill <-') 
        pkill mpv
        option='';;
esac
